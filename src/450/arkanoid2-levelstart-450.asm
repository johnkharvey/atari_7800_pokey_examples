...
PLAYTUNE 
	LDA #00; 16-bit mode on channels 2 and 3, clocked at 1.79 mhz
	STA AUDCTL
	LDA #139
...
CNTVOLTBL:
	.byte $a0,$a7,$c7,$a7,$A7,$A7,$A7,$AB 	;$B7 silences volume output on channel 1 to stop interference
...
CHANNLTBL:
	.byte  $01,$00,$02,$03,$01,$02,$03,$01 ; must set $00 and $01 to use 16-bit combined channel
...
TUNE00:   
	.byte 162,162
	.byte 136,0,144,162,182,144,162,0,0
		;A	4061	0FDD	144	90	
;A#	3832	0EF8	136	88	
;B	3617	0E21	128	80	
...
DURN00:
	.byte 18,6
	.byte 24,24,12,12,12,12,24,48,0
TUNE01:
	.byte 72,72
	.byte 60,0,64,72,81,64,72,0,0
...
TUNE02:
	.byte 14
	.byte 167,$0e,146,98,131,98,131,98,0
...
DURN02:
    .byte 24
	.byte 36,12,48,12,12,12,12,12,0
