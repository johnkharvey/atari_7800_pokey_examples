...
PLAYTUNE 
	LDA #$50 ; 16-bit mode on all four channnels, clocked at 1.79 mhz
	STA AUDCTL
	LDA #$00
	JSR DOTUNE
	LDA #$01
...
CNTVOLTBL:
	.byte $00,$27,$a7,$a7,$A7,$A7,$A7,$AB 	;$B7 silences volume output on channel 1 to stop interference
...
TUNE00:
	...
	.byte $36,$30,$2a,$00,$2a,$2a,$30,$36,$30
	.byte $00,$43,$0e
	.byte $30,$30,$30,$30,$27,$2a,$30,$36,0
...
TUNE03:   
	.byte 0
	.byte 0,108,108,108,108,121,121,121,121
